...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        main_camera_button =(Button)findViewById(R.id.main_camera_button);
        main_kinds_button =(Button)findViewById(R.id.main_kinds_button);
        main_map_button =(Button)findViewById(R.id.main_map_button);
        main_instruction_button =(Button)findViewById(R.id.main_instruction_button);
        main_settings_button =(Button)findViewById(R.id.main_settings_button);
        ...
        //seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            //public void onProgressChanged(SeekBar arg0, int progress, boolean arg2) {
                //main_camera_button.setTextSize(progress);
                //main_kinds_button.setTextSize(progress);
                //main_map_button.setTextSize(progress);
                //main_instruction_button.setTextSize(progress);
                //main_settings_button.setTextSize(progress);
